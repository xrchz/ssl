...
write s0 i0_ref c = (return_state (s0 with <|cs1 := (fmap_update s0.cs1 (i0_ref,(*MyDynArray.to_string*) c))|>))
`;
...
ops1 = <|
    ...
    get_parent1 := (\ _x_ . \ d0_ref . if d0_ref = [] then NONE else SOME(butlast d0_ref,last d0_ref));
    ...
    touch1 := (touch);
    write1 := (write);
    set_symlink1 := (\ _x_ . \ _x_ . \ f . failwith "set_symlink")
  |>
`;
